...
void main() {
  test('file.read template has expected ports and config', () {
    final registry = NodeTypeRegistry.fallback();
  ...
  test('node created from server node type has ports and default config', () {
    ...
    final registry = NodeTypeRegistry.fromServerNodeTypes(
      defs,
